...
function openCardActivity(activityId, activityUrl, pin, num, againUserIndex) {
  return new Promise((resolve) => {
    ...
    if (process.env.jd_zdjr_activityId60)
      activityId = process.env.jd_zdjr_activityId60;
    if (process.env.jd_zdjr_activityUrl60)
      activityUrl = process.env.jd_zdjr_activityUrl60;
...
// 152b6c5ae5b84a88a39a1dec34be2c11 这个还有打水
// 1dd895c75bda49aeb47481ae404c58da
(async () => {
  await openCardActivity(
    "6543d84ba9c34db9a29b8701ba4244ec",
