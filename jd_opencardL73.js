...
————————————————
入口：[ 2.14~2.21 瓜分百万京豆，0元赢取甜蜜好礼 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=union235434985dzlhkk&shareUuid=
)]

请求太频繁会被黑ip
过10分钟再执行

cron:30 1,12 14-21 2 *
============Quantumultx===============
[task_local]
#2.14~2.21 瓜分百万京豆，0元赢取甜蜜好礼
30 1,12 14-21 2 * jd_opencardL73.js, tag=2.14~2.21 瓜分百万京豆，0元赢取甜蜜好礼, enabled=true

*/
const $ = new Env("2.14~2.21 瓜分百万京豆，0元赢取甜蜜好礼");
...
!(async () => {
  ...
  $.shareUuid = "806a17cbe2aa41d682588d90c45e81b6"
